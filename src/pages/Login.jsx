    ...
    <div className="auth-container">
      <div className="auth-card" style={{ width: "min(36rem, 100%)" }}>
        ...
        <p className="helper-text" style={{ marginTop: 0 }}>
          Sign in with your email and password, or keep using Google if that is
          how your account was created.
        </p>

        <form className="auth-form" onSubmit={handlePasswordLogin}>
          <div className="page-stack" style={{ gap: "0.85rem", marginTop: "1.25rem" }}>
        ...
        >
          ...
          <span style={{ fontSize: "0.85rem", fontWeight: 600 }}>or continue with</span>
          <div style={{ flex: 1, height: "1px", background: "rgba(148, 163, 184, 0.2)" }} />
        </div>
