    ...
    const syncLiveScores = async (currentGames = null) => {
        try {
            ...
            for (const espnGame of espnGames) {
                ...
                if (dbGame) {
                    const newStatus = espnGame.status === 'post' ? 'finished' : 
                                    (espnGame.status === 'pre' ? 'scheduled' : 'in_progress');
                ...
                <View style={styles.teamsContainer}>
                    ...
                    <TouchableOpacity
                        style={[
                            ...
                            pickStatus === 'correct' && userPick === game.team_a && styles.teamButtonCorrect,
                            pickStatus === 'incorrect' && userPick === game.team_a && styles.teamButtonIncorrect,
                        ]}
                    ...
                    >
                        ...
                        <View style={styles.teamStatus}>
                            ...
                            {game.status === 'finished' && didTeamCover(game, game.team_a) && (
                    ...
                    {teamAPicks.length > 0 && (
                        <View style={styles.picksRow}>
                            {teamAPicks.slice(0, 5).map((pick, idx) => (
                                <View key={idx} style={[styles.avatarWrapper, idx > 0 && styles.avatarOverlap]}>
                                    <Avatar 
                    ...
                    <TouchableOpacity
                        style={[
                            ...
                            isLocked && styles.teamButtonLocked,
                            pickStatus === 'correct' && userPick === game.team_b && styles.teamButtonCorrect,
                            pickStatus === 'incorrect' && userPick === game.team_b && styles.teamButtonIncorrect,
                        ]}
                    ...
                    >
                        ...
                        <View style={styles.teamStatus}>
                            ...
                            {game.status === 'finished' && didTeamCover(game, game.team_b) && (
                                <View style={styles.coverBadge}>
                                    <Text style={styles.coverText}>Covered</Text>
                                </View>
                            )}
